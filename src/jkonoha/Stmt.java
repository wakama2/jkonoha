...
public class Stmt extends KObject {
	...
	public boolean parseSyntaxRule(CTX ctx, Stmt stmt, List<Object> tls, int s, int e) {
		boolean ret = false;
		Syntax syn = KonohaSpace_getSyntaxRule(ctx, stmt, tls, s, e);//TODO KonohaSpace_getSyntaxRule
		assert (syn != null);
